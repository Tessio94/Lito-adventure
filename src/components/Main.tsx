...
const Main = () => {
	return (
		<main
			id="tours"
			className="pt-20 px-[20px] sm:px-[40px] lg:px-[50px] 2xl:px-[160px]"
		>
			...
			<div className="flex lg:flex-row flex-col items-start justify-between gap-10">
				<div className="flex flex-col gap-5 items-start lg:basis-[40%] lg:max-w-[40%] text-2xl">
					<p className="font-lato text-3xl font-bold xl:text-4xl mb-5">
						Discover Zadar in the most fun and active way—with our guided bike
						tours!
					</p>
					<p className="text-2xl xl:text-3xl font-lato">
				...
				<div className="max-w-full lg:basis-[55%] lg:max-w-[55%] bg-color1/10 p-3 rounded-2xl">
					<Gallery />
				</div>
			</div>
		</main>
